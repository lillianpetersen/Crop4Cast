...
#celery = Celery('compute_ndvi_forCloud', broker='redis://localhost:6379')
...
#    for j in range(10):
        ...
        try:
            data_range = band_info['ndvi']['data_range']
            ...
            arrNDVI, meta = dl.raster.ndarray(
               ...
               # scales=[[data_range[0], data_range[1], physical_range[0], physical_range[1]], None],
                scales=[[data_range[0], data_range[1], physical_range[0], physical_range[1]], None],
               # scales=[[physical_range[0], physical_range[1]]],
                data_type='Float32'
                #data_type='UInt16'
                )
        except:
	...
	###############################################
        ...
        #######################
        try:
            data_range = band_info['visual_cloud_mask']['data_range']
            ...
            arrCloud, meta = dl.raster.ndarray(
                ...
                scales=[[data_range[0], data_range[1]]],
                data_type='Float32'
                )
        except:
...
#                if maskforCloud[v,h]==0 and maskforNDVI[v,h]==0 and oceanMask[v,h]==0:
                if maskforCloud[v,h]==0 and maskforNDVI[v,h]==0:
                    Mask[v,h,k]=0
...
#                cloudAll[v,h,k]=arrCloud[v,h,0]
        ...
        try:
            data_range = band_info['nir']['data_range']
        ...
        try:
            data_range = band_info['green']['data_range']
...
tile=-1 
for dltile in dltiles['features']:
     tile+=1      
     print 'dltile: '+str(tile)+' of '+str(len(dltiles['features']))
#     tile_function.apply_async([dltile])
#     print 'before dltiles ', tile
